...
public class TestData {
	...
	public void getSavedAuditStep(final AuditStepView auditStepView, int selectedJobId, final AuditWork auditWork,
			final VerticalPanel exceptions, final Employee loggedInEmployee) {
		...
		rpcService.getSavedAuditStep(selectedJobId, auditWork.getAuditWorkId(), new AsyncCallback<AuditStep>() {
			...
			public void onSuccess(final AuditStep auditStep) {
				if (auditStep.getAuditStepId() != 0) {
					...
					auditStepView.disableFields(exceptions, null);
