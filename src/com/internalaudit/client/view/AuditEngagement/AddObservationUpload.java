...
public class AddObservationUpload extends VerticalPanel {
	...
	public AddObservationUpload(final String subFolder, final String mainFolder) {
...
//		}
		...
		formSubmission(subFolder, mainFolder);
		add(form);
...
//		setWidth("370px");
	...
	private void formSubmission(final String subFolder, final String mainFolder) {
	...
	public void saveUploadException(String subFolder) {
	...
	public boolean fetchProcedureAttachments(final String subFolder, final String mainFolder) {
		rpcService.fetchAuditStepsProcerdure(subFolder, mainFolder, new AsyncCallback<ArrayList<String>>() {
			...
			private void clickHandlers(final String subFolder, final String mainFolder, Image delete,
				...
				delete.addClickHandler(new ClickHandler() {
					...
					public void onClick(ClickEvent event) {
						lblfilename = null;
						removeAttachedFile(subFolder, mainFolder, upperCasedJobLink);
					}
				});
	...
	public void onlyViewAttachment() {
		delete.setVisible(false);
		upload.setVisible(false);
	}

	public void removeAttachedFile(final String subFolder, final String mainFolder,
			final String upperCasedJobLink) {
